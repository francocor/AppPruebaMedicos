...
export default function SettingsMenu({ visible, onClose }) {
  ...
  return (
    <div className="absolute right-4 w-[220px] bg-gradient-to-b from-white via-[#2e3192] to-[#03aced] rounded-2xl shadow-lg p-4 z-50 top-[110px] sm:top-[85px] transition-all duration-300 ease-in-out">
      {/* Flechita para volver */}
      <button onClick={onClose} className="mb-2 flex items-center gap-2 text-black hover:text-blue-700">
