...
import NavbarProfesionales from "./NavbarProfesionales";
...
export default function Header() {
  ...
  {(user?.role === "admin" || user?.role === "master") && <NavbarAdmin />}
  {user?.role === "secretaria" && <NavbarSecretaria />}
  {user?.role === "profesional" && <NavbarProfesionales />}
